          ...
          <div class="card">
            <div class="card-body">
              <p class="font-weight-bold text-dark m-0">
                ...
                <span class="badge bg-warning text-small ml-3">{{ $transaction->status }}</span>
              </p>
              ...
              @endif
              <p class="m-0">Pembelian : @if ($transaction->purchases->isNotEmpty() && $transaction->purchases[0]->product)
